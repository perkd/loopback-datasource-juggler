          ...
          if (value === null || value === undefined) {
            ...
            if (DataType === List) {
              ...
              this.__data[propertyName] = (value instanceof DataType) ?
                cloneParentedModelForParent(value, this, DataType) :
...
ModelBuilder.prototype.resolveType = function(prop, isSubProperty) {
  ...
  if (typeof prop === 'string') {
    ...
    if (!isSubProperty && prop.type) {
      ...
      // Pass the current ModelBuilder settings to ensure strictEmbeddedModels is respected
      ...
      // Only enable parentRef for anonymous models by default
      // For named models, it must be explicitly enabled
      const parentRef = true; // Always enable for anonymous models
