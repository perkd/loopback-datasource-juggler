    ...
    targetModel.find(params, options, function(err, data) {
      ...
      if (scopeOnRelatedModel === true) {
        ...
        const smartMerge = function(idCollection, qWhere) {
          ...
          const intersect = idsA.filter(function(idA) {
            return idsB.some(function(idB) {
              return isDeepStrictEqual(idA, idB);
            });
          });
        ...
        if (queryRelated.where !== undefined) {
          ...
          // return empty result
          if (IdKeyCondition[IdKey] !== null &&
            typeof IdKeyCondition[IdKey] === 'object' &&
            Object.keys(IdKeyCondition[IdKey]).length === 0) {
            return cb(null, []);
          }
          ...
          const mergedWhere = {
            and: [
              IdKeyCondition,
              Object.fromEntries(Object.entries(queryRelated.where).filter(function(entry) {
                return entry[0] !== IdKey;
              })),
            ],
          };
